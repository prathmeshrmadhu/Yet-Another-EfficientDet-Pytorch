...
from eficocotools import EFI_COCO
...
ap.add_argument('-ds', '--data_path', type=str, default='datasets/', help='the root folder of dataset')
ap.add_argument('-valid_path', '--valid_csv_path', required=True, help='path to the validation data csv')
...
def evaluate_coco(image_path, set_name, image_ids, efi_coco_gt, model, threshold=0.05):
    results = []
    ...
    for image_id in tqdm(image_ids):
        image_info = efi_coco_gt.loadImgs(image_id)[0]
        img_path = image_path + image_info['file_name']
